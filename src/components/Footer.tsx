          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+15551234567" className="hover:text-[#D4AF37] transition-colors">+1 (555) 123-4567</a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={20} className="text-[#D4AF37] shrink-0" />
                <a href="mailto:support@circularfunds.com" className="hover:text-[#D4AF37] transition-colors">support@circularfunds.com</a>
              </li>
            </ul>
          </div>
        </div>
